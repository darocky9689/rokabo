...
const leistungen: Leistung[] = [
  {
    ...
    audience: 'Für alle, die schnell und schlank online sein wollen',
    pages: 'Single Page',
    seo: 'SEO Basis',
    careCoins: '–',
  ...
  {
    title: 'Professional',
    description: 'Das Fokuspaket: mehrere Seiten und laufende Weiterentwicklung.',
    audience: 'Für alle, die Leistungen, Referenzen und Details zeigen wollen',
  ...
  },
  {
    ...
    audience: 'Für alle mit hohem Anspruch an Umfang und Sichtbarkeit',
